---
title: "Run Billar Pro Backend with Docker Compose"
...
<Steps>
  ...
  <Step title="Configure application.yml">
    ...
    Edit `src/main/resources/application.yml` and replace `TU_CONTRASEÑA_AQUI` with your chosen password. Also confirm the JDBC URL uses port `5433`:
