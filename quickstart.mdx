---
title: "Get Started with Billar Pro Backend"
sidebarTitle: "Quickstart"
description: "Run Billar Pro Backend locally in five steps: clone the repo, start PostgreSQL with Docker, configure the application, build with Maven, and make your first API call."
---
